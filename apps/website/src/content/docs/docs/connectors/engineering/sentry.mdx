---
title: 'Sentry'
description: 'Sync issues, issue events, releases, and hourly error rates from a Sentry organization.'
---

{/* sentry: generated from connector metadata. Do not edit. */}

import { Aside, Badge } from '@astrojs/starlight/components';

<p style="display:flex;align-items:center;gap:0.75rem;margin:0 0 1rem;">
  <img
    src="/connectors/sentry.svg"
    alt="Sentry logo"
    width="40"
    height="40"
  ...
  <Badge text="@rawdash/connector-sentry" variant="note" />
</p>

Sync issues, issue events, releases, and hourly error rates from a Sentry organization.

<Aside title="Vendor">
  Data source: [Sentry](https://sentry.io) · [API
