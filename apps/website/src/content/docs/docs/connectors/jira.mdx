---
title: 'Jira'
description: 'Sync projects, users, sprints, issues, and issue status-change events from a Jira Cloud site.'
---

{/* jira: generated from connector metadata. Do not edit. */}

import { Aside, Badge } from '@astrojs/starlight/components';

<p style="display:flex;align-items:center;gap:0.75rem;margin:0 0 1rem;">
  <img
    src="/connectors/jira.svg"
    alt="Jira logo"
    width="40"
    height="40"
  ...
  <Badge text="@rawdash/connector-jira" variant="note" />
</p>

Sync projects, users, sprints, issues, and issue status-change events from a Jira Cloud site.

<Aside title="Vendor">
  Data source: [Atlassian](https://www.atlassian.com/software/jira) · [API
