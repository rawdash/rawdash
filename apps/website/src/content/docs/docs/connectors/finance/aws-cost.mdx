...
description: 'Track AWS spend over time and projected month-end costs, optionally broken down by service, account, tag, or cost category.'
---

{/* aws-cost: generated from connector metadata. Do not edit. */}

import { Aside, Badge } from '@astrojs/starlight/components';

<p style="display:flex;align-items:center;gap:0.75rem;margin:0 0 1rem;">
  <img
    src="/connectors/aws-cost.svg"
  ...
  <Badge text="@rawdash/connector-aws-cost" variant="note" />
</p>
...
<Aside type="caution" title="Cost & frequency">
  Each AWS Cost Explorer query is billed $0.01; avoid syncing more often than
  necessary. Recommended sync interval: **1 day**. Minimum sensible interval:
  **1 hour**. Each sync costs roughly: 2 Cost Explorer queries (about $0.02).
</Aside>

<Aside title="Vendor">
  Data source: [Amazon Web
  Services](https://aws.amazon.com/aws-cost-management/aws-cost-explorer/) ·
  [API
  docs](https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Operations_AWS_Cost_Explorer_Service.html)
</Aside>
