---
title: 'PostHog'
description: 'Sync feature flags, per-day event volume, feature flag usage, active users, and funnel conversion from a PostHog project.'
---

{/* posthog: generated from connector metadata. Do not edit. */}

import { Aside, Badge } from '@astrojs/starlight/components';

<p style="display:flex;align-items:center;gap:0.75rem;margin:0 0 1rem;">
  <img
    src="/connectors/posthog.svg"
    alt="PostHog logo"
    width="40"
    height="40"
