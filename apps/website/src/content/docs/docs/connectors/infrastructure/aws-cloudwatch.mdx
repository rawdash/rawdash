...
description: 'Pull declared CloudWatch metric time series (any namespace, statistic, and period) into a single metric series per query.'
---

{/* aws-cloudwatch: generated from connector metadata. Do not edit. */}

import { Aside, Badge } from '@astrojs/starlight/components';

<p style="display:flex;align-items:center;gap:0.75rem;margin:0 0 1rem;">
  <img
    src="/connectors/aws-cloudwatch.svg"
  ...
  <Badge text="@rawdash/connector-aws-cloudwatch" variant="note" />
</p>
...
<Aside type="caution" title="Cost & frequency">
  CloudWatch GetMetricData is billed per metric requested on the paid tier;
  high-frequency syncs over many metrics add up.
</Aside>

<Aside title="Vendor">
  Data source: [Amazon Web Services](https://aws.amazon.com/cloudwatch/) · [API
  docs](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_GetMetricData.html)
</Aside>
