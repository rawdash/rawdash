...
const releaseResponseSchema = z.array(
  z.object({
    ...
    projects: z.array(
      z.object({
        slug: z.string().min(1),
        hasHealthData: z.boolean().nullable().optional(),
    ...
    currentProjectMeta: z.record(z.string(), z.unknown()).nullable().optional(),
    data: z.record(z.string(), z.unknown()).nullable().optional(),
    deployCount: z.number().nullable().optional(),
    ...
    versionInfo: z.record(z.string(), z.unknown()).nullable().optional(),
  }),
);
