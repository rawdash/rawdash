...
const issueResponseSchema = z.array(
  z.object({
    ...
    lifetime: z.unknown().nullable().optional(),
    ...
    statusDetails: z.unknown().nullable().optional(),
...
const releaseResponseSchema = z.array(
  z.object({
    ...
    projects: z.array(
      z.object({
        slug: z.string().min(1),
        hasHealthData: z.unknown().nullable().optional(),
        id: z.unknown().nullable().optional(),
        name: z.unknown().nullable().optional(),
        newGroups: z.unknown().nullable().optional(),
        platform: z.unknown().nullable().optional(),
        platforms: z.unknown().nullable().optional(),
      }),
    ),
    authors: z.unknown().nullable().optional(),
    commitCount: z.unknown().nullable().optional(),
    currentProjectMeta: z.unknown().nullable().optional(),
    data: z.unknown().nullable().optional(),
    deployCount: z.unknown().nullable().optional(),
